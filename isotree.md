...
Notez qu'il s'agit d'un modèle de boîte noire qui ne produira pas d'explications ou d'importances - pour une approche différente de la détection des valeurs aberrantes explicables, voir OutlierTree.
