...
/*
 * Fit IsolationTreeEnsemble model, or variant of it such as SCiForest
 */
//sowD2

ISOTREE_EXPORTED
int fit_iforest1(IsolationTreeEnsemble *model_outputs, ExtIsoForest *model_outputs_ext,
...
ISOTREE_EXPORTED
int add_tree1(IsolationTreeEnsemble *model_outputs, ExtIsoForest *model_outputs_ext,
             real_t numeric_data[],  size_t ncols_numeric,
             int    categ_data[],    size_t ncols_categ,    int ncat[],
             real_t Xc[], sparse_ix Xc_ind[], sparse_ix Xc_indptr[],
             size_t ndim, size_t ntry, CoefType coef_type, bool coef_by_prop,
...
*/
ISOTREE_EXPORTED void get_num_nodes(IsolationTreeEnsemble &model_outputs, sparse_ix *n_nodes, sparse_ix *n_terminal, int nthreads) noexcept;
/* Serialize additional trees into previous serialized bytes
*
*/

ISOTREE_EXPORTED
bool check_can_undergo_incremental_serialization(const IsolationTreeEnsemble &model, const char *serialized_bytes);
ISOTREE_EXPORTED
size_t determine_serialized_size_additional_trees(const IsolationTreeEnsemble &model, size_t old_ntrees);
ISOTREE_EXPORTED
void incremental_serialize_IsolationTreeEnsemble(const IsolationTreeEnsemble &model, char *old_bytes_reallocated);
ISOTREE_EXPORTED
void incremental_serialize_IsolationTreeEnsemble(const IsolationTreeEnsemble &model, std::string &old_bytes);
...
ISOTREE_EXPORTED
std::string generate_sql_with_select_from1(IsolationTreeEnsemble * *model_outputs, ExtIsoForest *model_outputs_ext,
...
ISOTREE_EXPORTED
std::vector<std::string> generate_sql1(IsolationTreeEnsemble * *model_outputs, ExtIsoForest *model_outputs_ext,
                                      std::vector<std::string> &numeric_colnames, std::vector<std::string> &categ_colnames,
                                      std::vector<std::vector<std::string>> &categ_levels,
                                      bool output_tree_num, bool index1, bool single_tree, size_t tree_num,
                                      int nthreads);
ISOTREE_EXPORTED
void set_reference_points1(IsolationTreeEnsemble *model_outputs, ExtIsoForest *model_outputs_ext, TreesIndexer *indexer,
