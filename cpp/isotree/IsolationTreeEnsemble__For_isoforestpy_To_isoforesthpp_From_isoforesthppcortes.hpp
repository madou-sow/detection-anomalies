...
ISOTREE_EXPORTED
int fit_iforest1(IsolationTreeEnsemble *);
ISOTREE_EXPORTED
int add_tree1(IsolationTreeEnsemble * );
ISOTREE_EXPORTED void get_num_nodes(IsolationTreeEnsemble &) noexcept;
ISOTREE_EXPORTED
std::string generate_sql_with_select_from1(IsolationTreeEnsemble * );
ISOTREE_EXPORTED
std::vector<std::string> generate_sql1(IsolationTreeEnsemble * );
ISOTREE_EXPORTED
void set_reference_points1(IsolationTreeEnsemble * );
ISOTREE_EXPORTED
